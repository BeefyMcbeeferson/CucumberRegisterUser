Feature: Different registration scenarios of a new user on webpage

  Scenario Outline: Successful registration
    #Given User is on the correct "<url>" and "<browser>"
  ...
  Scenario Outline: Registration last name is missing
    #Given User is on the correct "<url>" and "<browser>"
    Given User is on the correct "<url>"
  ...
  Scenario Outline: Registration password doesn't match
    #Given User is on the correct "<url>" and "<browser>"
    Given User is on the correct "<url>"
    And User enter "<DateOfBirth>" "<First Name>" and "<Last Name>"
    And User enter email "<Email>" and "<confirmEmail>"
  ...
  Scenario Outline: Registration terms and conditions is not checked
    #Given User is on the correct "<url>" and "<browser>"
    Given User is on the correct "<url>"
    And User enter "<DateOfBirth>" "<First Name>" and "<Last Name>"
    And User enter email "<Email>" and "<confirmEmail>"
