Feature: Create New User
  ...
  Scenario Outline: Registration a new user on webpage
    ...
    Examples:
     ...
     |edge    | https://membership.basketballengland.co.uk/NewFullAccount | 12/02/1980  | Robert     | Lucas     | robert.lucaas.82@gmail.com | robert.lucaas.82@gmail.com |+46702064151|  male  |   Swedish   | Sweden           | Anna      | wife         | +46768778384| 31 The Square, Tarland, Aberdeenshire Scotland | Aberchirder| AB34 4TX  | Aberdeenshire | Sweden    | EttEnkeltLösenord | EttEnkeltLösenord| prefer not to say | prefer not to say  |prefer not to say | clicked              |clicked                   |clicked          |  yes  |
